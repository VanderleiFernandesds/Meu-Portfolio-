...
function Projects() {
  return (
    <section id="projects" className="relative overflow-hidden bg-white py-24 dark:bg-neutral-950">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.article
              ...
              variants={fadeUp}
              className="group flex flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-900/5 shadow-lg shadow-black/5 backdrop-blur-sm transition-colors hover:border-teal-700/40 dark:border-white/10 dark:bg-white/5 dark:shadow-black/20"
            >
              <div
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <p className="mt-3 flex-1 text-sm leading-relaxed text-neutral-600 dark:text-white/60">
                  {project.description}
                </p>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="rounded-full border border-neutral-200 bg-neutral-900/5 px-3 py-1 text-xs text-neutral-600 dark:border-white/10 dark:bg-white/5 dark:text-white/70"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="mt-6 flex items-center gap-3">
                  <a
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-neutral-900/5 px-4 py-2.5 text-sm font-medium text-neutral-900 transition-colors hover:bg-neutral-900/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-500 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-500 dark:bg-white dark:text-neutral-900"
                  >
